...
<?PHP
	...
	echo '</table>';
	echo '<a href="person_bearbeiten1.php">&laquo; Diese Daten bearbeiten</a><br />&nbsp;';
	...
	echo '</table>';
	echo '<a href="person_bearbeiten2.php">&laquo; Diese Daten bearbeiten</a><br />&nbsp;';
...
<a href="person_bearbeiten.php">&laquo; Diese Daten bearbeiten</a>
<br /><br />
<form action="person_bearbeiten5.php"><input class="rand" type="submit" value="Speichern" /></form>
</body>
</html>