...
echo '<table id="gruppen2">';
	...
	echo '<a href="person_bearbeiten/daten_laden.php?id='.$_GET['id'].'" title="Diese Person bearbeiten"><img src="eicons/person_bearbeiten.png" width="64" height="64" alt="Diese Person bearbeiten" border="0" /></a>';
